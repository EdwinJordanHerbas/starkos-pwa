...
if docker ps --format '{{.Names}}' | grep -q '^postgres$'; then
  for M in migration.sql migration-v5.sql migration-v6.sql migration-v7.sql migration-v8.sql migration-v9.sql migration-v10.sql migration-v11.sql migration-v12.sql migration-v13.sql migration-v14.sql migration-v15.sql migration-v16.sql; do
